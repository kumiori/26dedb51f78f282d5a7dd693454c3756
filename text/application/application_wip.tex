...
\node[anchor=south east,text=signal,font=\metafont\fontsize{6}{7}\selectfont] at ([xshift=-10mm,yshift=8mm]current page.south east) {#1 / 19};
\end{tikzpicture}\par}
...
\begin{minipage}{\mainmeasure}
  ...
  \vspace{12mm}
  {\color{signal}\fontsize{15}{22}\selectfont
    \[
      \mathcal W_t=\{w_1,w_2,\ldots,w_n\},\qquad
      \mathcal R_t\subseteq\mathcal W_t\!\times\!\mathcal W_t,\qquad
      \mathcal G_t=(\mathcal W_t,\mathcal R_t).
    \]}
  \vspace{12mm}
...
% 16 CREDITS
\meta{APPLICATION}{CURRENT ALLOCATION}\folio{19}\sidelegend
\vspace*{45mm}\hspace*{62mm}
\begin{minipage}{\mainmeasure}
  ...
  \begin{minipage}{50mm}
    \centering
    \href{https://takeover-fotografiska.streamlit.app/}{%
      \includegraphics[width=43mm]{assets/takeover_fotografiska_qr.png}}\par
    \vspace{3mm}
    \smallcapsline{ENTER THE CURRENT STATE}\par
    \vspace{1mm}
    {\metafont\fontsize{6.2}{7.5}\selectfont
      takeover-fotografiska.streamlit.app}
  \end{minipage}
\end{minipage}
\end{document}
