...
\node[anchor=south east,text=signal,font=\metafont\fontsize{6}{7}\selectfont] at ([xshift=-10mm,yshift=8mm]current page.south east) {#1 / 25};
\end{tikzpicture}\par}
...
\begin{minipage}{\mainmeasure}
  ...
  \vspace{6mm}
  {\fontsize{9.4}{11.6}\selectfont\justifying
    I come to this project from theoretical mechanics and applied mathematics,
    where I work on irreversible systems, instability, singular perturbations
    and forms of analysis that begin precisely where an algebraic description
    stops being enough. A small perturbation can leave the state almost
    unchanged. Or it can change the admissible trajectory completely. Once the
    system moves, returning to the previous state may no longer be possible.
    I look at community in much the same way. Not as an object. Not as a sum of
    individuals. Not as consensus. As an evolving configuration of relations.\par\vspace{3mm}
    ...
    architecture remains. The ecclesia does not. This is our initial condition.\par\vspace{3mm}

    There is another partition underneath the work. Before extraction comes
    separation: subject from object, living from inert, possessor from possessed.
    The figure emerging from underground is deliberately difficult to place on
    either side. The code it carries is technical until it germinates into flowers.
    The ruin is inert until it calls an assembly. TAKE OVER disturbs the partitions
    by which that order is constructed. Nothing here exists completely first and
    enters into relation afterward. Relations themselves begin producing the
    objects, bodies and spaces of the work.\par\vspace{2.5mm}

    \begin{tikzpicture}[remember picture,overlay]
      \node[anchor=north west,text width=42mm,align=left]
        at ([xshift=13mm,yshift=-112mm]current page.north west)
        {{\relationfont\itshape\fontsize{8.2}{10.2}\selectfont
        ``Before becoming a market, it required a cosmogony: a world divided
        between subjects and objects, living beings and inert matter, those who
        possess and what can be possessed.''\par\vspace{2mm}
        \normalfont\fontsize{7}{8}\selectfont GRAZIANO MAZZA}};
    \end{tikzpicture}
    ...
    Each produces another possible direction.\par\vspace{2mm}
    ...
    Ave Palm, Mai-Brit T\"anava, Kenn-Eerik Kannike, and Andrés A.
    Le\'on Baldelli / kumiori III remain attributable authors. Difference remains
    visible while relations grow.\par\vspace{3mm}
    ...
    it is another initial condition.\par\vspace{3mm}
...
% D0 GRAZIANO MAZZA / INTERRUPTION
\meta{INTERRUPTION}{CONTRIBUTION / D0}
\folio{D0}
\vspace*{33mm}\hspace*{27mm}
\begin{minipage}{156mm}
  {\RaggedRight\displayfont\fontsize{29}{29}\selectfont
    THE KINGDOM HAS ENDED\par}
  \vspace{3mm}
  {\fontsize{12}{14}\selectfont\textbf{Graziano Mazza}\par}
  {\relationfont\itshape\fontsize{9}{11}\selectfont
    contribution / D0 / 19.08.2026\par}
  \vspace{10mm}
  {\fontsize{9.6}{12.4}\selectfont\justifying
  Capitalism has never been only an economic system. Before becoming a market,
  it required a cosmogony: a world divided between subjects and objects, living
  beings and inert matter, those who possess and what can be possessed. Extraction
  begins here, in the metaphysical gesture that transforms the world into something
  available, measurable, and exchangeable. This architecture has started to
  collapse. The photographs do not stage nature reclaiming civilization, nor do
  they imagine an Eden after catastrophe. They occupy instead the unstable zone
  in which the distinctions that sustained modernity cease to function: organism
  and mineral, technology and geology, waste and habitat, artificial surface and
  biological growth become part of the same contaminated field.\par\vspace{4mm}

  Modernity needed an inert world, whereas the technicity of radicalized that
  necessity. The contemporary crisis reveals the violence of this fiction because
  matter increasingly refuses the passivity assigned to it. We like the atmospheres
  entering the bodies, plastics entering the blood, industrial residues becoming
  geological strata, organisms and infrastructures modifying one another. The
  environment is no longer a background against which human history unfolds. This
  is the gnosis proposed by the project to gain a hidden transcendence: we must
  discover that there was never an outside from which humanity could govern the
  world. Images do not simply ask that non-human beings be granted greater moral
  visibility; we question the structure that made the Human sovereign in the first
  place. The point is not to enlarge the kingdom, but to remove the throne.\par\vspace{4mm}

  This is the terminal form of a theology of separation, whose ideal subject is
  autonomous, proprietary and detached from the relations that sustain it. Its
  crisis becomes visible when this independence can no longer be believed. The
  atmosphere cannot be separated from the body that breathes it, geological time
  cannot be reduced to economic time, and collapse cannot remain an externality.
  The project proposes another theology, one without transcendence and without a
  chosen species, in which creation does not culminate in mankind and matter no
  longer waits to receive its function. Nothing exists first and enters into
  relation afterward, our relations themselves temporarily produce bodies,
  environments and forms of life.\par\vspace{4mm}

  The apocalypse announced here is the collapse of an older revelation: the belief
  that the world was made outside of our desires. They had survived this collapse
  for a long time, but the world has the newest theological authority, and we are
  here to possess and free from it simultaneously.}
\end{minipage}
\newpage
...
\hspace*{14mm}\begin{minipage}{182mm}
  \begin{tikzpicture}[x=1mm,y=1mm]
    ...
    \node[anchor=south west,inner sep=0,draw=signal,line width=.45pt,rotate=-2]
      at (0,58) {\includegraphics[width=49mm,height=31mm]{../../assets/exhibition_frames/01_entry.png}};
    \node[anchor=south west,inner sep=0,draw=signal,line width=.45pt,rotate=2]
      at (42,68) {\includegraphics[width=52mm,height=30mm]{../../assets/exhibition_frames/02_wall.png}};
    \node[anchor=south west,inner sep=0,draw=signal,line width=.45pt,rotate=-1]
      at (88,57) {\includegraphics[width=52mm,height=32mm]{../../assets/exhibition_frames/03_turn.png}};
    \node[anchor=south west,inner sep=0,draw=signal,line width=.45pt,rotate=2]
      at (132,68) {\includegraphics[width=48mm,height=30mm]{../../assets/exhibition_frames/04_field.png}};
    \node[anchor=south west,inner sep=0,draw=signal,line width=.45pt,rotate=-2]
      at (125,25) {\includegraphics[width=52mm,height=32mm]{../../assets/exhibition_frames/05_return.png}};
    \node[anchor=south west,inner sep=0,draw=signal,line width=.45pt,rotate=1]
      at (68,12) {\includegraphics[width=60mm,height=37mm]{../../assets/exhibition_frames/06_sound.png}};
    \node[anchor=south west,inner sep=0,draw=signal,line width=.45pt,rotate=-1]
      at (5,20) {\includegraphics[width=66mm,height=38mm]{../../assets/exhibition_frames/07_projection.png}};
...
\begin{minipage}{\mainmeasure}
  ...
  \vspace{12mm}
  {\color{signal}\fontsize{14.5}{22}\selectfont\boldmath
    \[
      \boldsymbol{\mathcal W
      =\{\mathrm{image},\mathrm{voice},\mathrm{sound},\mathrm{body},
      \mathrm{practice},\ldots\}\,+\,\mathcal R}
    \]}
  \vspace{10mm}
  {\fontsize{10.8}{14}\selectfont
  What matters is what appears between them. Here $\mathcal W$ names the field of
  attributable contributions: images, voices, sounds, bodies, places, and
  practices. $\mathcal R$ is the evolving set of relations that we cannot
  prescribe in advance. The plus sign does not mean ordinary numerical addition;
  it marks the relations active between distinct elements. This is where the
  project becomes a game.\par\vspace{5mm}
...
\begin{minipage}{180mm}
  ...
  \vspace{7mm}
  \begin{tikzpicture}[x=1mm,y=1mm]
    \galleryfit{assets/ave/ave-01-ccw-pi4-cw.jpg}{0}{0}{87}{48}{01 / AVE}
    \galleryfit{assets/ave/ave-02.jpg}{92}{0}{87}{48}{02 / AVE}
    \gallerymissing{0}{-53}{87}{48}{03}
    \galleryfit{assets/ave/ave-03.jpg}{92}{-53}{87}{48}{04 / AVE}
    \galleryfit{assets/selection/photo-000.png}{0}{-106}{87}{48}{05 / kumiori}
    \galleryfit{assets/ave/ave-04-cw.jpg}{92}{-106}{87}{48}{06 / AVE}
    \galleryfit{assets/ave/ave-05.jpg}{0}{-159}{87}{48}{07 / AVE}
    \galleryfit{assets/selection/photo-001-turn180.png}{92}{-159}{87}{48}{08 / kumiori}
  \end{tikzpicture}\par
  \vspace{4mm}
...
\begin{minipage}{180mm}
  ...
  \vspace{7mm}
  \begin{tikzpicture}[x=1mm,y=1mm]
    \galleryfit{assets/selection/photo-004-cw.png}{0}{0}{87}{48}{09 / kumiori}
    \gallerymissing{92}{0}{87}{48}{10}
    \galleryfit{assets/ave/ave-06-ccw.jpg}{0}{-53}{87}{48}{11 / AVE}
    \galleryfit{assets/selection/photo-002-qr03.png}{92}{-53}{87}{48}{12 / kumiori}
    \galleryfit{assets/ave/ave-07-reset-cw.jpg}{0}{-106}{87}{48}{13 / AVE}
    \galleryfit{assets/selection/photo-003-cw.png}{92}{-106}{87}{48}{14 / kumiori}
    \gallerymissing{0}{-159}{87}{48}{15}
    \galleryfit{assets/selection/photo-005.png}{92}{-159}{87}{48}{16 / kumiori}
  \end{tikzpicture}\par
  \vspace{4mm}
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=north west,inner sep=0]
    at ([xshift=116mm,yshift=-135mm]current page.north west)
    {\includegraphics[width=31mm,height=32mm]{assets/qr_sketch_dark.png}};
...
\begin{minipage}{179mm}
  \begin{minipage}[t]{112mm}
    ...
    {\metafont\fontsize{6.5}{8}\selectfont
      ...
      Mai-Brit T\"anava / Kenn-Eerik Kannike / Graziano Mazza.\\[2mm]
