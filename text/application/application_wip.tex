...
\node[anchor=south east,text=signal,font=\metafont\fontsize{6}{7}\selectfont] at ([xshift=-10mm,yshift=8mm]current page.south east) {#1 / 22};
\end{tikzpicture}\par}
...
% 15 YOUR TURN
\meta{OPEN}{NEXT NODE}\folio{18}\sidelegend
\networkbg{15}
\vspace*{58mm}
\begin{center}
...
% 16 SELECTED IMAGES / OPEN POSITIONS
...
\begin{minipage}{179mm}
  {\RaggedRight\displayfont\fontsize{25}{25}\selectfont
    SELECTED IMAGES /\\POSITIONS HELD OPEN.}\par
  \vspace{7mm}
  \begin{tikzpicture}[x=1mm,y=1mm]
    % The opening image is the two-column anchor: twice the former width.
    \masonrywidth{assets/selection/photo-000.png}{0}{0}{116}{82}
    % The second selection is rotated upright and completes the top register.
    \masonryheight{assets/selection/photo-001-rotated.png}{119}{0}{60}{82}
    % Lower register: unequal columns continue the masonry rhythm.
    \masonryheight{assets/selection/photo-002.png}{0}{-84}{55}{65}
    \missingmasonry{0}{-151}{55}{36}

    \missingmasonry{58}{-84}{72}{28}
    \masonrywidth{assets/selection/photo-004.png}{58}{-114}{72}{42}
    \missingmasonry{58}{-158}{72}{30}

    \missingmasonry{133}{-84}{45}{60}
    \missingmasonry{133}{-146}{45}{41}
  \end{tikzpicture}\par
  \vspace{4mm}
  \smallcapsline{Four selected images / four positions held open / one plate follows.}
\end{minipage}
\newpage

% 17 FOURTH IMAGE / FULL PLATE
\thispagestyle{empty}
\null
\begin{tikzpicture}[remember picture,overlay]
...
% 18 BACK COVER / EXTRA / CREDITS
\thispagestyle{empty}
\null
\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=north west,inner sep=0] at (current page.north west)
    {\includegraphics[height=\paperheight]{assets/selection/photo-005.png}};
  \fill[white,opacity=.86] ([xshift=10mm,yshift=-38mm]current page.north west) rectangle ++(190mm,-78mm);
  \fill[white,opacity=.90] ([xshift=10mm,yshift=-10mm]current page.north west) rectangle ++(43mm,-17mm);
  \node[anchor=north west,align=left,text width=38mm] at ([xshift=13mm,yshift=-13mm]current page.north west)
    {\metafont\fontsize{6.5}{8}\selectfont EXTRA / NOT IN\\CURRENT SELECTION};
\end{tikzpicture}
\vspace*{112mm}\hspace*{14mm}
\begin{minipage}{179mm}
...
% 19 SUGGESTED LISTENING / FINE PRINT
\thispagestyle{empty}
