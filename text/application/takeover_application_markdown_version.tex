...
\node[anchor=south east,text=signal,font=\metafont\fontsize{6}{7}\selectfont] at ([xshift=-10mm,yshift=8mm]current page.south east) {#1 / 16};
\end{tikzpicture}\par}
...
\begin{minipage}{128mm}
  ...
  \vspace{8mm}
  {\fontsize{17}{22}\selectfont\itshape goes through the wall.}\par
  \vspace{22mm}
  {\fontsize{20}{25}\selectfont
    \[
      \begin{aligned}
      \mathrm{image}&\longrightarrow\mathrm{voice}\longrightarrow\mathrm{sound}\\
      &\longrightarrow\mathrm{person}\longrightarrow\mathrm{practice}
      \end{aligned}
    \]}
\end{minipage}
\newpage
...
\begin{minipage}{128mm}
  ...
  \begin{minipage}{78mm}
    {\fontsize{13}{17}\selectfont\itshape
      ``Mai-Brit [SURNAME] enters in the frame and through voice. Her recorded contribution opens another perspective from inside it.''}
  \end{minipage}
  \hfill
...
\begin{minipage}{128mm}
  ...
  {\fontsize{11.5}{15}\selectfont
    TAKE OVER begins as an individual application that is already becoming something else. Andrés A. León Baldelli / KUMIORI, Ave [SURNAME], Mai-Brit [SURNAME], and Kenn-Eerik [SURNAME] remain attributable authors. Their contributions are not merged into anonymous collective authorship. Here, $\mathcal R$ is not fixed in advance: it is the evolving set of relations between contributors, works, places, and encounters.}
\end{minipage}
\newpage
...
\begin{minipage}{180mm}
  \photobox[205mm]{AVE [SURNAME] / PROVISIONAL SELECTION}
  \vspace{4mm}
...
\begin{minipage}{128mm}
  ...
  {\fontsize{14}{19}\selectfont
    Sound is location and grounding. Some QR portals carry recordings made at or in relation to the photographed sites; others carry voices or composed material. Kenn-Eerik [SURNAME] develops the sonic trajectory through recordings, listening, and live electronic concert.}
  \vspace{26mm}
  \begin{center}
    \begin{tikzpicture}
...
% 14 BIO
\meta{APPLICANT}{SHORT BIO}\folio{14}\sidelegend
\vspace*{45mm}\hspace*{62mm}
\begin{minipage}{128mm}
...
% 15 YOUR TURN
\meta{OPEN}{NEXT NODE}\folio{15}\sidelegend
\networkbg{15}
\vspace*{58mm}
\begin{center}
...
% 16 CREDITS
\meta{APPLICATION}{CURRENT ALLOCATION}\folio{16}\sidelegend
\vspace*{45mm}\hspace*{62mm}
\begin{minipage}{128mm}
  ...
  01 & KUMIORI & 08 & AVE [provisional] \\
  02 & KUMIORI & 08 & AVE [provisional] \\
  03 & KUMIORI & 08 & AVE [provisional] \\
  04 & KUMIORI & 08 & AVE [provisional] \\
  05 & KUMIORI & 08 & AVE [provisional] \\
  06 & KUMIORI & 08 & AVE [provisional] \\
  07 & AVE [provisional] & 13 & UNALLOCATED \\
  14 & UNALLOCATED & 15 & UNALLOCATED \\
  \end{tabular}\par
  \vspace{24mm}
